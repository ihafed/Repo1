...
<?php
	...
	mysql_select_db("student_services");
       ...
       $res=mysql_query("select * from classOf2014");
	...
	echo "<td><font color='#F3E7C2'><center>"; echo $row["st_name"]; echo "</td>";
	echo "<td><font color='#F3E7C2'><center>"; echo $row["st_major"]; echo "</td>";
	echo "<td><font color='#F3E7C2'><center>"; echo $row["st_semester"]; echo "</td>";
	echo "<td><font color='#F3E7C2'><center>"; echo $row["st_email"]; echo "</td>";

...
<?php
	...
	mysql_select_db("student_services");
       ...
       $res=mysql_query("select * from classOf2013");

	echo"<table border=1 align=center> 
	<tr><th><font color='#CC9900'><font size= '4'>Name</font></strong></font></th><th><font color='#CC9900'><font size= '4'>Major</font></font></th><th><font color='#CC9900'><font size= '4'>Semester</font></font></th><th><font color='#CC9900'><font size= '4'>Email</font></tr>";
	while($row=mysql_fetch_array($res))
	{
	echo "<tr> ";


	echo "<td><font color='#F3E7C2'><center>"; echo $row["stud_name"]; echo "</td>";
	echo "<td><font color='#F3E7C2'><center>"; echo $row["stud_major"]; echo "</td>";
	echo "<td><font color='#F3E7C2'><center>"; echo $row["stud_semester"]; echo "</td>";
	echo "<td><font color='#F3E7C2'><center>"; echo $row["stud_email"]; echo "</td>";
...
<center><a href="Alumni.html"><img src="images/Back1.jpg" width="90" height="30" alt="" border="0" /></a></center>
